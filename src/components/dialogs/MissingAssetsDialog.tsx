...
export function MissingAssetsDialog() {
  ...
  return (
    ...
    >
      <div
        className={`bg-zinc-900 border border-zinc-800/80 rounded-2xl shadow-2xl w-[440px] max-h-[400px] flex flex-col overflow-hidden ${closing ? "animate-scale-out" : "animate-scale-in"}`}
