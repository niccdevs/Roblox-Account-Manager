...
export function AccountUtilsDialog({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    ...
    >
      <div
        className={`bg-zinc-900 border border-zinc-800/80 rounded-2xl shadow-2xl w-[540px] max-h-[600px] flex flex-col overflow-hidden ${closing ? "animate-scale-out" : "animate-scale-in"}`}
